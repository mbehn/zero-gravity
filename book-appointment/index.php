...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://mbehn.com/zginstitute/style.css">
...
<div id="page-wrapper">
	...
	<div id="header">
		<div id="main-banner">
			<a href="index.html"><h1 id="page-title"><span id="zero">Zero</span><span id="gravity">Gravity</span><span id="institute">Institute</span></h1></a>
		...
		<div id="navigation">
			<nav>
				<ul>
					<li><a href="#">intro to floating</a></li>
					<li><a href="http://mbehn.com/zginstitute/book-appointment/index.php">book an appointment</a></li>
